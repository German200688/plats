...
SoftwareSerial mySerialIN8(4, 3);
...
SoftwareSerial mySerialIN2(8, 21);
...
int incomingByteIN88;
int incomingByteIN89;
...
int incomingByteIN98;
int incomingByteIN99;
...
int incomingByteIN18;
int incomingByteIN19;
...
int incomingByteIN28;
int incomingByteIN29;
...
int incomingByteIN38;
int incomingByteIN39;
...
int incomingByteIN48;
int incomingByteIN49;
...
int incomingByteIN58;
int incomingByteIN59;
...
int incomingByteIN68;
int incomingByteIN69;
...
int incomingByteIN78;
int incomingByteIN79;


void setup() {
//Serial.begin(115200);

mySerialIN1.begin(38400);

mySerialIN2.begin(38400);
mySerialIN3.begin(38400);
mySerialIN4.begin(38400);
mySerialIN5.begin(38400);
mySerialIN6.begin(38400);
mySerialIN7.begin(38400);

mySerialIN8.begin(38400);

//mySerialIN9.begin(57600);

mySerialOUT1.begin(57600);
Serial.begin(57600);
...
testIN8 = 0;
  ...
  incomingByteIN77 = 0; 
  incomingByteIN78 = 0;
  incomingByteIN79 = 0;   // переменная для хранения полученного байта
...
// IN1 чтение
    ...
    {  //если есть доступные данные
      ...
      if (testIN1 == 0 && incomingByteIN10 > 10) {
        ...
        incomingByteIN19 = incomingByteIN18;
        incomingByteIN18 = incomingByteIN17;        
        incomingByteIN17 = incomingByteIN16;
        incomingByteIN16 = incomingByteIN15;
...
// IN2 чтение
    ...
    {  //если есть доступные данные
      ...
      if (testIN2 == 0 && incomingByteIN20 > 10) {
        ...
        incomingByteIN29 = incomingByteIN28;
        incomingByteIN28 = incomingByteIN27;        
        incomingByteIN27 = incomingByteIN26;
        incomingByteIN26 = incomingByteIN25; 
 ...
 // IN3 чтение
    ...
    {  //если есть доступные данные
      ...
      if (testIN3 == 0 && incomingByteIN30 > 10) {
        ...
        incomingByteIN39 = incomingByteIN38;
        incomingByteIN38 = incomingByteIN37;
        incomingByteIN37 = incomingByteIN36;
        incomingByteIN36 = incomingByteIN35;        
  ...
  // IN4 чтение
    ...
    {  //если есть доступные данные
      ...
      if (testIN4 == 0 && incomingByteIN40 > 10) {
        ...
        incomingByteIN49 = incomingByteIN48;
        incomingByteIN48 = incomingByteIN47;
        incomingByteIN47 = incomingByteIN46;
        incomingByteIN46 = incomingByteIN45;  
...
// IN5 чтение
    ...
    {  //если есть доступные данные
      ...
      if (testIN5 == 0 && incomingByteIN50 > 10) {
        ...
        incomingByteIN59 = incomingByteIN58;
        incomingByteIN58 = incomingByteIN57;
        incomingByteIN57 = incomingByteIN56;
        incomingByteIN56 = incomingByteIN55;         
   ...
   // IN6 чтение
    ...
    {  //если есть доступные данные
      ...
      if (testIN6 == 0 && incomingByteIN60 > 10) {
        ...
        incomingByteIN69 = incomingByteIN68;
        incomingByteIN68 = incomingByteIN67;
        incomingByteIN67 = incomingByteIN66;
        incomingByteIN66 = incomingByteIN65;         
  ...
  // IN7 чтение
    ...
    {  //если есть доступные данные
      ...
      if (testIN7 == 0 && incomingByteIN70 > 10) {
        ...
        incomingByteIN79 = incomingByteIN78;
        incomingByteIN78 = incomingByteIN77;
        incomingByteIN77 = incomingByteIN76;
        incomingByteIN76 = incomingByteIN75;         
...
Serial.write(incomingByteIN89);
Serial.write(incomingByteIN88);
Serial.write(incomingByteIN87);
Serial.write(incomingByteIN86);
...
Serial.write(incomingByteIN19);
Serial.write(incomingByteIN18);
Serial.write(incomingByteIN17);
Serial.write(incomingByteIN16);
...
Serial.write(incomingByteIN29);
Serial.write(incomingByteIN28);
Serial.write(incomingByteIN27);
Serial.write(incomingByteIN26);
...
Serial.write(incomingByteIN39);
Serial.write(incomingByteIN38);
Serial.write(incomingByteIN37);
Serial.write(incomingByteIN36);
...
Serial.write(incomingByteIN49);
Serial.write(incomingByteIN48);
Serial.write(incomingByteIN47);
Serial.write(incomingByteIN46);
...
Serial.write(incomingByteIN59);
Serial.write(incomingByteIN58);
Serial.write(incomingByteIN57);
Serial.write(incomingByteIN56);
...
Serial.write(incomingByteIN69);
Serial.write(incomingByteIN68);
Serial.write(incomingByteIN67);
Serial.write(incomingByteIN66);
...
Serial.write(incomingByteIN79);
Serial.write(incomingByteIN78);
Serial.write(incomingByteIN77);
Serial.write(incomingByteIN76);
