...
mySerialIN1.begin(19200);

mySerialIN2.begin(19200);
mySerialIN3.begin(19200);
mySerialIN4.begin(19200);
mySerialIN5.begin(19200);
mySerialIN6.begin(19200);
mySerialIN7.begin(19200);

mySerialIN8.begin(19200);

//mySerialIN9.begin(57600);

mySerialOUT1.begin(38400);
Serial.begin(38400);
